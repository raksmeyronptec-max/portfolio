...
export const km: Dictionary = {
  ...
  about: {
    title: "អំពីខ្ញុំ",
    eyebrow: "អំពីខ្ញុំ · ការអប់រំ × គណិតវិទ្យា × បច្ចេកវិទ្យា",
    heroHeadline: "ខ្ញុំបង្កើតផលិតផលអប់រំចេញពីបទពិសោធន៍ក្នុងថ្នាក់រៀន។",
    heroLede: "ខ្ញុំជាអ្នកអប់រំ និស្សិតគណិតវិទ្យា និងវិស្វករផលិតផលនៅកម្ពុជា។ ការងាររបស់ខ្ញុំភ្ជាប់ការអនុវត្តបង្រៀន ការទទួលបានធនធានសិក្សា និងការអភិវឌ្ឍកម្មវិធីពេញលេញ។",
    exploreStory: "ស្វែងយល់រឿងរ៉ាវរបស់ខ្ញុំ",
    viewResume: "មើលប្រវត្តិរូប",
    contact: "ទំនាក់ទំនងខ្ញុំ",
    portraitAlt: "រូបថត រុន រស្មី អ្នកអប់រំ និងអ្នកបង្កើតផលិតផលបច្ចេកវិទ្យាអប់រំ។",
    introductionEyebrow: "បុគ្គលនៅពីក្រោយផលិតផល",
    introductionHeading: "លើសពីតួនាទីវិជ្ជាជីវៈតែមួយ",
    introductionFallback: "ការបណ្តុះបណ្តាលគ្រូ គណិតវិទ្យាអនុវត្ត និងវិស្វកម្មផលិតផល មិនមែនជាចំណាប់អារម្មណ៍ដាច់ដោយឡែកពីគ្នាទេ។ វាជាការអនុវត្តតែមួយ៖ ស្វែងយល់ពីរបៀបដែលមនុស្សរៀន ហើយបង្កើតប្រព័ន្ធជាក់ស្តែងឆ្លើយតបតម្រូវការនោះ។",
    practiceConnection: "ខ្ញុំមិនរចនាផលិតផលអប់រំដោយផ្អែកលើកម្មវិធីតែមួយមុខទេ។ ការអនុវត្តក្នុងថ្នាក់រៀនជួយឱ្យខ្ញុំយល់ពីដំណើរការ ដែនកំណត់ និងតម្រូវការនៅពីក្រោយវា។",
    educationPractice: "ការអនុវត្តអប់រំ",
    productPractice: "ការអនុវត្តផលិតផល",
    sharedPurpose: "គោលបំណងរួម",
    sharedPurposeBody: "ធ្វើឱ្យការបង្រៀន ការរៀន និងចំណេះដឹងសិក្សាងាយទទួលបាន។",
    storyEyebrow: "ជំពូកសំខាន់ៗ",
    storyHeading: "ការអនុវត្តដែលកើតចេញពីការសិក្សា និងបទពិសោធន៍",
    storyDescription: "លំដាប់ពេលវេលាសង្ខេបដែលយកពីកំណត់ត្រាអប់រំ បទពិសោធន៍ និងដំណើរដែលបានផ្សព្វផ្សាយ។",
    viewEvidence: "មើលភស្តុតាង",
    purposeEyebrow: "គោលបំណង",
    purposeHeading: "បញ្ហាដែលខ្ញុំជ្រើសរើសដោះស្រាយ",
    purposeDescription: "ការឆ្លើយតបនីមួយៗគឺជាផលិតផលដែលបានផ្សព្វផ្សាយ និងភ្ជាប់នឹងតម្រូវការអប់រំ ឬការទទួលបានចំណេះដឹងជាក់ស្តែង។",
    projectDetail: "មើលគម្រោង",
    visitLive: "ចូលមើលផលិតផល",
    principlesEyebrow: "គោលការណ៍ការងារ",
    principlesHeading: "អ្វីដែលណែនាំការងាររបស់ខ្ញុំ",
    principles: [
      { title: "ចាប់ផ្តើមពីបញ្ហាពិត", body: "ស្វែងយល់ពីគ្រូ សិស្ស និងស្ថាប័ន មុននឹងជ្រើសរើសបច្ចេកវិទ្យា។" },
      { title: "បង្កើតសម្រាប់បរិបទកម្ពុជា", body: "គិតពីភាសាខ្មែរ ដំណើរការក្នុងស្រុក ឧបករណ៍ និងការតភ្ជាប់ជាក់ស្តែង។" },
      { title: "ធ្វើឱ្យចំណេះដឹងងាយទទួលបាន", body: "រៀបចំធនធានសិក្សាឱ្យមនុស្សអាចស្វែងរក យល់ និងប្រើប្រាស់បាន។" },
      { title: "រចនាដើម្បីទំនុកចិត្ត", body: "ចាត់ទុកភាពងាយស្រួលប្រើ ឯកជនភាព សិទ្ធិ និងការទំនាក់ទំនងច្បាស់លាស់ជាតម្រូវការផលិតផល។" },
      { title: "បន្តរៀនតាមរយៈការអនុវត្ត", body: "ភ្ជាប់ការសិក្សានៅសាកលវិទ្យាល័យ ការអនុវត្តបង្រៀន ការស្រាវជ្រាវ និងវិស្វកម្ម។" },
    ],
    studiesEyebrow: "ផ្លូវសិក្សាពីរ",
    studiesHeading: "ការបណ្តុះបណ្តាលគ្រូ និងគណិតវិទ្យារួមគ្នាក្នុងបច្ចេកវិទ្យាអប់រំ",
    teacherEducation: "ការអប់រំគ្រូបឋមសិក្សា",
    teacherEducationBody: "របៀបដែលមនុស្សរៀន របៀបរៀបចំមេរៀន របៀបដំណើរការថ្នាក់រៀន និងរបៀបវាយតម្លៃអ្នករៀន។",
    mathematics: "គណិតវិទ្យាអនុវត្ត",
    mathematicsBody: "របៀបរៀបចំបញ្ហា របៀបទំនាក់ទំនងហេតុផល និងរបៀបពន្យល់គំនិតគណិតវិទ្យា។",
    convergence: "ចំណុចរួម",
    convergenceBody: "ផលិតផលដែលផ្អែកលើគរុកោសល្យ ការគិតហេតុផល និងការអនុវត្តជាក់ស្តែង។",
    evidenceEyebrow: "ភស្តុតាងជ្រើសរើស",
    evidenceHeading: "ការងារនៅពីក្រោយរឿងរ៉ាវ",
    academicPractice: "ការអនុវត្តសិក្សា",
    productWork: "ការងារផលិតផល",
    authoredWork: "ស្នាដៃនិពន្ធ",
    processEyebrow: "វិធីសាស្ត្រ",
    processHeading: "របៀបដែលខ្ញុំធ្វើការ",
    process: [
      { title: "សង្កេត", body: "ស្វែងយល់ដំណើរការថ្នាក់រៀន គ្រូ និងការសិក្សា។" },
      { title: "ស្រាវជ្រាវ", body: "កំណត់អ្នកប្រើ ដែនកំណត់ និងតម្រូវការព័ត៌មាន។" },
      { title: "រចនា", body: "បង្កើតស្ថាបត្យកម្មព័ត៌មាន គំរូខ្លឹមសារ និងអន្តរកម្ម។" },
      { title: "បង្កើត", body: "អភិវឌ្ឍផ្ទៃប្រើប្រាស់ កម្មវិធីខាងក្រោយ មូលដ្ឋានទិន្នន័យ និងការគ្រប់គ្រង។" },
      { title: "កែលម្អ", body: "សាកល្បងភាពងាយប្រើ ភាពងាយស្រួលចូលប្រើ ប្រសិទ្ធភាព SEO និងភាពទុកចិត្តបាន។" },
    ],
    detailsEyebrow: "ព័ត៌មានផ្ទាល់ខ្លួន",
    detailsHeading: "ប្រវត្តិរូបសង្ខេប",
    currentStudies: "ការសិក្សាបច្ចុប្បន្ន",
    professionalFocus: "ការផ្តោតវិជ្ជាជីវៈ",
    professionalFocusValue: "ការអប់រំ គណិតវិទ្យា និងប្រព័ន្ធឌីជីថលជាក់ស្តែង",
    closingHeading: "ខ្ញុំចាប់អារម្មណ៍លើការងារដែលកែលម្អការបង្រៀន ការរៀន និងការទទួលបានចំណេះដឹង។",
    closingBody: "សម្រាប់ការសហការផ្នែកអប់រំ គណិតវិទ្យា ឬផលិតផលឌីជីថល សូមចាប់ផ្តើមការសន្ទនា។",
    viewWork: "មើលស្នាដៃជ្រើសរើស",
