...
export const en = {
  ...
  certificates: {
    ...
    allVerifications: "Any verification state",
    sortLabel: "Sort",
    sort: {
      newest: "Newest first",
      oldest: "Oldest first",
    ...
    noResultsHint: "Try a different search, or reset the filters.",
  ...
  about: {
    title: "About",
    eyebrow: "About · Education × Mathematics × Technology",
    heroHeadline: "I build education products from classroom experience.",
    heroLede: "I am an educator, mathematics student and product engineer based in Cambodia. My work connects teaching practice, academic-resource access and full-stack software development.",
    exploreStory: "Explore my story",
    viewResume: "View résumé",
    contact: "Contact me",
    portraitAlt: "Portrait of Ron Raksmey, an educator and education-technology product builder.",
    introductionEyebrow: "The person behind the products",
    introductionHeading: "More than one professional title",
    introductionFallback: "Teacher education, applied mathematics and product engineering are not separate interests in my work. They are one practice: understanding how people learn, then building practical systems around those needs.",
    practiceConnection: "I do not approach education products from software alone. Classroom practice helps me understand the workflows, limitations and needs behind them.",
    educationPractice: "Education practice",
    productPractice: "Product practice",
    sharedPurpose: "Shared purpose",
    sharedPurposeBody: "Better access to teaching, learning and academic knowledge.",
    storyEyebrow: "Selected chapters",
    storyHeading: "A practice shaped through study and experience",
    storyDescription: "A concise chronology drawn from published education, experience and journey records.",
    viewEvidence: "View evidence",
    purposeEyebrow: "Purpose",
    purposeHeading: "The problems I choose to work on",
    purposeDescription: "Each response is a published product, connected to a practical education or knowledge-access need.",
    projectDetail: "View project",
    visitLive: "Visit live product",
    principlesEyebrow: "Working principles",
    principlesHeading: "What guides the work",
    principles: [
      { title: "Start with the real problem", body: "Understand teachers, students and institutions before selecting technology." },
      { title: "Build for Cambodian context", body: "Consider Khmer language, local workflows, realistic devices and connectivity." },
      { title: "Make knowledge accessible", body: "Organize academic resources so people can discover, understand and use them." },
      { title: "Design for trust", body: "Treat accessibility, privacy, permissions and clear communication as product requirements." },
      { title: "Keep learning through practice", body: "Connect university study, teaching practice, research and engineering." },
    ],
    studiesEyebrow: "Two academic paths",
    studiesHeading: "Teacher education and mathematics converge in education technology",
    teacherEducation: "Primary teacher education",
    teacherEducationBody: "How people learn, how lessons are designed, how classrooms operate and how learners are assessed.",
    mathematics: "Applied mathematics",
    mathematicsBody: "How problems are structured, how reasoning is communicated and how mathematical ideas are explained.",
    convergence: "Convergence",
    convergenceBody: "Products grounded in pedagogy, reasoning and practical implementation.",
    evidenceEyebrow: "Selected evidence",
    evidenceHeading: "The work behind the story",
    academicPractice: "Academic practice",
    productWork: "Product work",
    authoredWork: "Authored work",
    processEyebrow: "Method",
    processHeading: "How I work",
    process: [
      { title: "Observe", body: "Understand classroom, teacher and academic workflows." },
      { title: "Research", body: "Define users, constraints and information needs." },
      { title: "Design", body: "Create information architecture, content models and interactions." },
      { title: "Build", body: "Develop the interface, backend, database and administration." },
      { title: "Improve", body: "Test usability, accessibility, performance, SEO and reliability." },
    ],
    detailsEyebrow: "Personal details",
    detailsHeading: "A concise profile",
    currentStudies: "Current studies",
    professionalFocus: "Professional focus",
    professionalFocusValue: "Education, mathematics and practical digital systems",
    closingHeading: "I am interested in work that improves teaching, learning and access to knowledge.",
    closingBody: "For education, mathematics or digital-product collaboration, let’s start a conversation.",
