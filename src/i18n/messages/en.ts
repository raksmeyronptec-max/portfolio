...
export const en = {
  ...
  about: {
    title: "About",
    seoTitle: "About Ron Raksmey | Educator and Education-Technology Product Builder",
    seoDescription: "Learn how Ron Raksmey combines teacher education, applied mathematics and full-stack product development to build practical education technology in Cambodia.",
    portraitAlt: "Portrait of Ron Raksmey, an educator and education-technology product builder.",
    hero: {
      number: "01",
      eyebrow: "Educator · Mathematics · Product engineering",
      headline: "I turn classroom and academic needs into practical digital systems.",
      introduction: "I am {name}, an educator, mathematics student and product builder based in Cambodia. My work connects teaching practice, academic knowledge and full-stack engineering.",
      explore: "Explore my story",
      resume: "View résumé",
      contact: "Contact me",
      identity: "Educator, mathematics student and product builder",
      location: "Based in",
      focus: "Connected practice",
      signals: ["Education", "Mathematics", "Product engineering"],
    },
    story: {
      number: "02",
      eyebrow: "My story",
      heading: "More than one professional title",
      opening: "Education, mathematics and engineering are parts of one practice.",
      statement: "Classroom practice reveals the real constraints. Mathematics sharpens the reasoning. Engineering turns both into tools people can use.",
      evidence: "Explore the evidence",
      education: "Education",
      experience: "Teaching experience",
      publications: "Mathematics publications",
    },
    practice: {
      number: "03",
      eyebrow: "Education × Product engineering",
      heading: "Two halves of the same practice",
      introduction: "The work begins with how people teach, learn and find knowledge—not with a technology choice.",
      educationTitle: "Education practice",
      educationBody: "Teacher education, lesson planning, classroom observation, mathematics instruction and learner assessment show how educational work happens in practice.",
      productTitle: "Product practice",
      productBody: "Product discovery, information architecture, UX/UI, full-stack engineering, database design, accessibility and technical SEO turn those needs into dependable systems.",
      evidence: "Published evidence",
      educationLink: "View education",
      experienceLink: "View teaching experience",
      projectsLink: "View selected projects",
      sharedLabel: "One purpose",
      sharedBody: "Better tools for teaching, learning and access to academic knowledge.",
    },
    chapters: {
      number: "04",
      eyebrow: "Selected chapters",
      heading: "The experiences that shaped the work",
      description: "Four published moments—not a second résumé—show how study, classroom practice and educational product work became connected.",
      currentStudiesTitle: "Two current academic paths",
      undated: "Date to be confirmed",
      link: "Read the related story",
    },
    purpose: {
      number: "05",
      eyebrow: "Purpose",
      heading: "Why I build education technology",
      description: "Each product responds to a documented problem in teaching, academic-resource access or the infrastructure behind it.",
      problem: "The problem",
    ...
    principlesFocus: {
      number: "06",
      eyebrow: "Principles and current focus",
      heading: "What guides the work now",
      principles: [
        { title: "Start with the real problem", body: "Understand teachers, learners and institutions before selecting technology." },
        { title: "Build for Cambodian context", body: "Consider Khmer language, local workflows, realistic devices and connectivity." },
        { title: "Make knowledge accessible", body: "Organize information so people can discover, understand and use it." },
        { title: "Design for trust", body: "Treat accessibility, privacy, permissions and clarity as core product requirements." },
      ],
      focusEyebrow: "Current focus",
      focusHeading: "Learning and practice in progress",
      focusDescription: "These items come from education and experience records explicitly marked as current.",
      study: "Study",
      practice: "Practice",
      product: "Product work",
      related: "View related evidence",
    },
    closing: {
      number: "07",
      eyebrow: "Personal details and contact",
      detailsHeading: "A few useful details",
      location: "Based in",
      studies: "Current studies",
      focus: "Professional focus",
      focusValue: "Education, mathematics and practical digital systems",
      languages: "Languages",
      availability: "Availability",
      contact: "Public contact",
      ctaEyebrow: "The person behind the products",
      heading: "I am interested in work that improves teaching, learning and access to knowledge.",
      body: "For education, mathematics or digital-product collaboration, let’s start a conversation.",
      contactAction: "Contact me",
      workAction: "View selected work",
      resumeAction: "Download résumé",
    },
  },
